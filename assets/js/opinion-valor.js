function setValorPersonalAnimado() {
  const valorFinal = 10; // Cambia aquí el valor deseado entre 1 y 10
  ...
  const intervalo = setInterval(() => {
    ...
    valorActual++;
  }, 150); // velocidad de animación en milisegundos
}

document.addEventListener("DOMContentLoaded", setValorPersonalAnimado);
