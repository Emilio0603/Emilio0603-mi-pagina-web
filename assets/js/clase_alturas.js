  ...
  switch (id) {
    case "info1":
      html = `
        ...
        <h2 class="panel-titulo">Crecimiento urbano desorganizado y casas en zonas altas</h2>
    ...
    case "info2":
      html = `
        ...
        <h2>Estado visual de las viviendas y participación ciudadana</h2>
    ...
    case "info3":
      html = `
        ...
        <h2>Impacto urbano en la fauna y la naturaleza</h2>
    ...
    <h2>Espacios recreativos sustentables y el contacto con la naturaleza</h2>
